        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <nav className="mt-3 flex flex-col gap-2">
              ...
              <Link to="/home?category=Business#events" className="text-sm text-slate-700 hover:text-emerald-600 transition">Business</Link>
              <Link to="/home?category=Festival#events" className="text-sm text-slate-700 hover:text-emerald-600 transition">Festivals</Link>
              <Link to="/home?category=Art#events" className="text-sm text-slate-700 hover:text-emerald-600 transition">Art</Link>
              <Link to="/home?category=Travel#events" className="text-sm text-slate-700 hover:text-emerald-600 transition">Travel</Link>
            </nav>
          </div>
